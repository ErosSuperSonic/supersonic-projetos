...
<section class="hero-ss">
        <div class="wrapper__text">
            <h1>Mensalidades em dia, o ano todo, sem dor de cabeça.</h1>
            <h2>Mais de 500 escolas já <strong>zeraram a inadimplência</strong> com a isaac</h2>
            ...
            <ul>
                <li>
                    ...
                    <p>100% de receita garantida o ano todo</p>
                </li>
                ...
                <li>
                    ...
                    <p>A gestão de cobrança fica por nossa conta</p>
                </li>
                ...
                <li>
                    ...
                    <p>Receba 100% das mensalidades, mesmo em caso de atraso ou inadimplência</p>
                </li>
            </ul>

            <div class="buttons-ss">
                <a href="/escolas" class="buttonBlue">Conheça nossa solução para escolas</a>
                <a href="/familia" class="buttonWhite">Conheça nossa solução para famílias</a>
            </div>
        </div>

        <div class="wrapper__img">
            <img src="https://assets.website-files.com/613a4aeb1cd38a810f6a1448/61a7892be433d67b4deb3023_hero-isaac%20(1).jpeg" alt="">
        </div>
    </section>

`
document.querySelector(".section-hero").insertAdjacentHTML("afterend", element__ss);


setTimeout(() => {
    document.querySelector(".hero-ss ").style.opacity = '1'
}, 1500)