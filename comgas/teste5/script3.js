...
function addTextInTitlePageTwo() {
    ...
    if (!document.querySelector(".content-page-two")) {
        ...
        document.querySelector(".content-page-two.deslogado").insertAdjacentHTML("afterbegin", "<h2>Informe o endereço da troca</h2>")
    }
}
...
function alterationTitle() {
    if (document.querySelector("#mainContent > div > ng-component > div > div > div.col-md-8.area-principal > h2")) {
        document.querySelector("#mainContent > div > ng-component > div > div > div.col-md-8.area-principal > h2").innerHTML = "Informe o endereço da troca"
    }
}
...
function previousPageOne() {
    //Titulo da pagina 1
    if (document.querySelector("#mainContent > div > ng-component > div > div > div.col-md-8.area-principal > h2")) {
        document.querySelector("#mainContent > div > ng-component > div > div > div.col-md-8.area-principal > h2").innerHTML = "Alteração de Titularidade"
    }

    //removendo seção da content-page-two da pagina 1
