...
function renderGallery(id_carousel, id_module) {
	...
	jQuery(document).load(function () {
		...
		jQuery(".empreendimento-modal").on("shown.bs.modal", function (e) {
			console.log("modal shown");
			var option = document.querySelector(
				".empreendimento-modal .buttons-dinamic li a.active"
			).innerText;
			...
			switch (option) {
				...
				case "PLANTAS":
					...
					break;
				default:
					containerColumn[1].style = "display: none !important";
					containerColumn[0].style =
...
document.querySelectorAll(".empreendimento-modal").forEach((el) =>{
