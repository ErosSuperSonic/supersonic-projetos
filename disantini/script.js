...
const tamanho = document.querySelector(
	"div.attributes>div:nth-of-type(3)>div:nth-of-type(1)"
);
...
btnGuiaTamanhos.addEventListener("click", () => {
	document
		.querySelector(".guia-tamanhos-ss-popup")
		.classList.toggle("active-ss");
});
...
document.querySelector("div.attributes>div:nth-of-type(3)").insertAdjacentHTML("afterend", `
<div class="infos-ss">
...
//Entender pq o botào não funciona
