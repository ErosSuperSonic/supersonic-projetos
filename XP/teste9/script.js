document.querySelector("div#element-32").innerHTML = `<h1 class="h1-ss">Invista de forma completa na <span style="color: #FBC105">maior corretora do Brasil</span></h1>`

document.querySelector("div#element-637").insertAdjacentHTML("beforeend", `<p class="copy-xp">Veja o que só quem é XP vê</p>`)

document.querySelector("div#element-637").insertAdjacentHTML("beforeend", `
<div class="container-lista-ss">
        <ul>
            <li>
            ...
            <li>
                ...
                Mais de R$715 bilhões sob custódia
            </li>
        </ul>
    </div>
`)
...
<div class="container-button">
        <a href="https://cadastro.xpi.com.br/desktop/step/1">Abra sua conta</a>
